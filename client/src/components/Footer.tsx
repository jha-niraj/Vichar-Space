        ...
        <footer className="bg-gray-800 text-white py-12">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        <h3 className="text-2xl font-semibold mb-4">VicharSpace</h3>
                        <p className="text-gray-400">Empowering writers to share their stories with the world.</p>
                    </div>
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link to="#" className="text-gray-400 hover:text-white transition-colors">Write</Link></li>
                ...
                <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400">
                    <p>&copy; {new Date().getFullYear()} VicharSpace. All rights reserved.</p>
                </div>
            </div>
        </footer>
    )
